...
namespace Facades\App\Examples\RealtimeFacades {
    /**
     * @mixin \App\Examples\Realtime\Greeting
     * @method static sayHello(string $string)
     */
    class Greeting extends \App\Examples\Realtime\Greeting
    {
    }
}
